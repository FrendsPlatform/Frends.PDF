...
namespace Frends.PDF.Create
{
    ...
    public class PDF
    {
        ...
        {
            if (string.IsNullOrWhiteSpace(pageContent.ImagePath) || !File.Exists(pageContent.ImagePath)) throw new FileNotFoundException($"Path to header graphics was empty or the file does not exist.");
